...
static void issue102(void) /* #128 */
{
    ...
    utf8proc_uint8_t nostripna[] = {0x78, 0xe2, 0x81, 0xa5, 0xc3, 0xa8, 0x61, 0x00}; /* "x\u2065\u00e8a" */
    ...
    printf("nostripna \"%s\" -> \"%s\" vs. \"%s\"\n", (char*)input, (char*)output, (char*)nostripna);
    check(strlen((char*) output) == 7, "incorrect nostripna length");
    check(!memcmp(nostripna, output, 8), "incorrect nostripna data");
}
